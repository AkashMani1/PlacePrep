...
export const DSA_KILL_LIST: Problem[] = [
  // Arrays & Strings
  d('dsa_001','Remove Element','Arrays & Strings','Easy','https://leetcode.com/problems/remove-element/','https://youtu.be/xj5XdNfm24'),
  d('dsa_002','Find the Index of the First Occurrence in a String','Arrays & Strings','Easy','https://leetcode.com/problems/find-the-index-of-the-first-occurrence-in-a-string/','https://youtu.be/WOZo3leWE98'),
  d('dsa_003','Longest Common Prefix','Arrays & Strings','Easy','https://leetcode.com/problems/longest-common-prefix/','https://youtu.be/P4rV9qW55Ck'),
  d('dsa_004','Length of Last Word','Arrays & Strings','Easy','https://leetcode.com/problems/length-of-last-word/','https://youtu.be/n8y0Twfcf-Y'),
  d('dsa_005','Roman to Integer','Arrays & Strings','Easy','https://leetcode.com/problems/roman-to-integer/','https://www.youtube.com/results?search_query=LeetCode+Roman+to+Integer'),
  d('dsa_006','Merge Sorted Array','Arrays & Strings','Easy','https://leetcode.com/problems/merge-sorted-array/','https://www.youtube.com/results?search_query=LeetCode+Merge+Sorted+Array'),
  d('dsa_007','Best Time to Buy and Sell Stock','Arrays & Strings','Easy','https://leetcode.com/problems/best-time-to-buy-and-sell-stock/','https://youtu.be/upkF2hUd5dq'),
  d('dsa_008','Remove Duplicates from Sorted Array II','Arrays & Strings','Medium','https://leetcode.com/problems/remove-duplicates-from-sorted-array-ii/','https://youtu.be/zl15jCfADpl'),
  d('dsa_009','Rotate Array','Arrays & Strings','Medium','https://leetcode.com/problems/rotate-array/','https://youtu.be/2tAyVoikNew'),
  d('dsa_010','Best Time to Buy and Sell Stock II','Arrays & Strings','Medium','https://leetcode.com/problems/best-time-to-buy-and-sell-stock-ii/','https://www.youtube.com/results?search_query=LeetCode+Best+Time+to+Buy+and+Sell+Stock+II'),
  d('dsa_011','Jump Game','Arrays & Strings','Medium','https://leetcode.com/problems/jump-game/','https://www.youtube.com/results?search_query=LeetCode+Jump+Game'),
  d('dsa_012','Reverse Words in a String','Arrays & Strings','Medium','https://leetcode.com/problems/reverse-words-in-a-string/','https://youtu.be/nP-vkiKyUuq'),
  d('dsa_013','Trapping Rain Water','Arrays & Strings','Hard','https://leetcode.com/problems/trapping-rain-water/','https://www.youtube.com/results?search_query=LeetCode+Trapping+Rain+Water'),
  d('dsa_014','Candy','Arrays & Strings','Hard','https://leetcode.com/problems/candy/','https://www.youtube.com/results?search_query=LeetCode+Candy'),
  d('dsa_015','Defanging an IP Address','Arrays & Strings','Easy','https://leetcode.com/problems/defanging-an-ip-address/','https://www.youtube.com/results?search_query=LeetCode+Defanging+an+IP+Address'),
  d('dsa_016','Maximum Number of Words Found in Sentences','Arrays & Strings','Easy','https://leetcode.com/problems/maximum-number-of-words-found-in-sentences/','https://youtu.be/qBSXZrU-ncw'),
  d('dsa_017','Check If Two String Arrays are Equivalent','Arrays & Strings','Easy','https://leetcode.com/problems/check-if-two-string-arrays-are-equivalent/','https://youtu.be/qzb5H7qF5wq'),
  d('dsa_018','Number of Senior Citizens','Arrays & Strings','Easy','https://leetcode.com/problems/number-of-senior-citizens/','https://youtu.be/qvy9B1JK-co'),
  d('dsa_019','Minimum Amount of Time to Collect Garbage','Arrays & Strings','Medium','https://leetcode.com/problems/minimum-amount-of-time-to-collect-garbage/','https://www.youtube.com/results?search_query=LeetCode+Minimum+Amount+of+Time+to+Collect+Garbage'),
  d('dsa_020','Find and Replace Pattern','Arrays & Strings','Medium','https://leetcode.com/problems/find-and-replace-pattern/','https://youtu.be/LKs-pWrm0aQ'),
  d('dsa_021','Number of Pairs of Strings With Concatenation','Arrays & Strings','Medium','https://leetcode.com/problems/number-of-pairs-of-strings-with-concatenation-equal-to-target/','https://youtu.be/O5khhibfKME'),
  d('dsa_022','Valid Number','Arrays & Strings','Hard','https://leetcode.com/problems/valid-number/','https://www.youtube.com/results?search_query=LeetCode+Valid+Number'),
  // Matrix
